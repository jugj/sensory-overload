...
{
    [SerializeField]float geschwindigkeit = 3f;

    [SerializeField]float sprungkraft = 5f;

    [SerializeField]int HP = 10;

    [SerializeField]float sprungkraftMult = 1.0f;

    [SerializeField]float geschwindigkeitMult = 1.0f;
